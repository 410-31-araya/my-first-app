...
st.markdown("# :red[ 3 คานาณค่าตับปีมวลภาย BMI]")
st.write("กรอกข้อมูลน้ำหนักและส่วนสูงของคุณ เพื่อเช็กสุขภาพเบื้องต้น")

#ส่วนที่ 2 สร้างช่องรับค่าน้ำหนัก และ ส่วนสูง
weight = st.number_input ("กรอกน้ำหนักของคุณ (กิโลกรัม) : ", min_value=1.0, Value=1,a)
height_cm = st.number_input("กรอกสวนสูงของคุณ (เซ่นติเมตร) : ", min_value=1.0, value=1.e)

#ส่วนที่ 3 สร้างปุ่มคดคำนวณ
...
if bmi < 18.5:
    ...
    st. into(" คุณเริ่มมีน้ำหนักเกินเกณฑ์ (ท้วม)")
else: 
